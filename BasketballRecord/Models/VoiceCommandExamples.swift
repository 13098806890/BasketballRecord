...
struct VoiceCommandExamples {
    ...
    private static let chineseTemplates = Templates(
        ...
        actionTemplates: [
            ...
            .putbackMade: ["{name}补篮", "{team}{number}号补篮", "{name}补篮命中"],
            .putbackMissed: ["{name}补篮不中", "{team}{number}号补篮不中", "{name}补篮没进"],
            .dunkMade: ["{name}扣篮", "{team}{number}号扣篮", "{name}扣篮命中"],
            .dunkMissed: ["{name}扣篮不中", "{team}{number}号扣篮未中", "{name}扣篮没进"],
    ...
    private static let traditionalChineseTemplates = Templates(
        ...
        actionTemplates: [
            ...
            .putbackMade: ["{name}補籃", "{team}{number}號補籃", "{name}補籃命中"],
            .putbackMissed: ["{name}補籃不中", "{team}{number}號補籃不中", "{name}補籃沒進"],
            .dunkMade: ["{name}扣籃", "{team}{number}號扣籃", "{name}扣籃命中"],
            .dunkMissed: ["{name}扣籃不中", "{team}{number}號扣籃未中", "{name}扣籃沒進"],
    ...
    private static let englishTemplates = Templates(
        ...
        actionTemplates: [
            ...
            .putbackMade: ["{name} putback", "{team} {number} putback", "{name} putback made"],
            .putbackMissed: ["{name} putback miss", "{team} {number} putback miss", "{name} putback no"],
            .dunkMade: ["{name} dunk", "{team} {number} dunk", "{name} dunk made"],
            .dunkMissed: ["{name} dunk miss", "{team} {number} dunk miss", "{name} dunk no"],
    ...
    private static let japaneseTemplates = Templates(
        ...
        actionTemplates: [
            ...
            .putbackMade: ["{name}パットバック", "{team}{number}番パットバック", "{name}パットバック成功"],
            .putbackMissed: ["{name}パットバック失敗", "{team}{number}番パットバック失敗", "{name}パットバックミス"],
            .dunkMade: ["{name}ダンク", "{team}{number}番ダンク", "{name}ダンク成功"],
            .dunkMissed: ["{name}ダンク失敗", "{team}{number}番ダンク失敗", "{name}ダンクミス"],
    ...
    private static let koreanTemplates = Templates(
        ...
        actionTemplates: [
            ...
            .putbackMade: ["{name} 팟백", "{team} {number}번 팟백", "{name} 팟백 성공"],
            .putbackMissed: ["{name} 팟백 실패", "{team} {number}번 팟백 실패", "{name} 팟백 미스"],
            .dunkMade: ["{name} 덩크", "{team} {number}번 덩크", "{name} 덩크 성공"],
            .dunkMissed: ["{name} 덩크 실패", "{team} {number}번 덩크 실패", "{name} 덩크 미스"],
    ...
    private static let germanTemplates = Templates(
        ...
        actionTemplates: [
            ...
            .putbackMade: ["{name} putback", "{team} {number} putback", "{name} putback getroffen"],
            .putbackMissed: ["{name} putback miss", "{team} {number} putback miss", "{name} putback verfehlt"],
            .dunkMade: ["{name} dunk", "{team} {number} dunk", "{name} dunk made"],
            .dunkMissed: ["{name} dunk miss", "{team} {number} dunk miss", "{name} dunk no"],
    ...
    private static let spanishTemplates = Templates(
        ...
        actionTemplates: [
            ...
            .putbackMade: ["{name} putback", "{team} {number} putback", "{name} putback anotado"],
            .putbackMissed: ["{name} putback miss", "{team} {number} putback miss", "{name} putback fallado"],
            .dunkMade: ["{name} dunk", "{team} {number} dunk", "{name} dunk made"],
            .dunkMissed: ["{name} dunk miss", "{team} {number} dunk miss", "{name} dunk no"],
    ...
    private static let frenchTemplates = Templates(
        ...
        actionTemplates: [
            ...
            .putbackMade: ["{name} putback", "{team} {number} putback", "{name} putback réussi"],
            .putbackMissed: ["{name} putback miss", "{team} {number} putback miss", "{name} putback manqué"],
            .dunkMade: ["{name} dunk", "{team} {number} dunk", "{name} dunk made"],
            .dunkMissed: ["{name} dunk miss", "{team} {number} dunk miss", "{name} dunk no"],
    ...
    private static let italianTemplates = Templates(
        ...
        actionTemplates: [
            ...
            .putbackMade: ["{name} putback", "{team} {number} putback", "{name} putback realizzato"],
            .putbackMissed: ["{name} putback miss", "{team} {number} putback miss", "{name} putback sbagliato"],
            .dunkMade: ["{name} dunk", "{team} {number} dunk", "{name} dunk made"],
            .dunkMissed: ["{name} dunk miss", "{team} {number} dunk miss", "{name} dunk no"],
    ...
    private static let russianTemplates = Templates(
        ...
        actionTemplates: [
            ...
            .putbackMade: ["{name} путбэк", "{team} {number} путбэк", "{name} путбэк забит"],
            .putbackMissed: ["{name} путбэк промах", "{team} {number} путбэк промах", "{name} путбэк не забит"],
            .dunkMade: ["{name} данк", "{team} {number} данк", "{name} данк забит"],
            .dunkMissed: ["{name} данк промах", "{team} {number} данк промах", "{name} данк не забит"],
