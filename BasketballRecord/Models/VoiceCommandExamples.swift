...
struct VoiceCommandExamples {
    ...
    private static let chineseTemplates = Templates(
        ...
        statTypeNames: [
            ("stat.foul", "犯规"), ("stat.rebound", "篮板"), ("stat.assist", "助攻"),
        ...
        actionTemplates: [
            .twoMade: ["{name}两分", "{number}号两分", "{team}{number}号两分", "{name}两分进了"],
            .twoMissed: ["{number}号两分不中", "{name}两分没进", "{number}号两分没中"],
            .threeMade: ["{name}三分", "{number}号三分", "{name}三分进了"],
            .threeMissed: ["{name}三分不中", "{number}号三分没进", "{name}三分没中"],
            .freeThrowMade: ["{name}罚球", "{number}号罚球", "{name}罚球进了"],
            .freeThrowMissed: ["{name}罚球不中", "{number}号罚球没进", "{name}罚球没中"],
            .layupMade: ["{name}上篮", "{number}号上篮", "{name}上篮进了"],
            .midRangeMade: ["{name}中投", "{number}号中距离", "{name}中投进了"],
    ...
    private static let traditionalChineseTemplates = Templates(
        ...
        statTypeNames: [
            ("stat.foul", "犯規"), ("stat.rebound", "籃板"), ("stat.assist", "助攻"),
        ...
        actionTemplates: [
            .twoMade: ["{name}兩分", "{number}號兩分", "{team}{number}號兩分", "{name}兩分進了"],
            .twoMissed: ["{number}號兩分不中", "{name}兩分沒進", "{number}號兩分沒中"],
            .threeMade: ["{name}三分", "{number}號三分", "{name}三分進了"],
            .threeMissed: ["{name}三分不中", "{number}號三分沒進", "{name}三分沒中"],
            .freeThrowMade: ["{name}罰球", "{number}號罰球", "{name}罰球進了"],
            .freeThrowMissed: ["{name}罰球不中", "{number}號罰球沒進", "{name}罰球沒中"],
            .layupMade: ["{name}上籃", "{number}號上籃", "{name}上籃進了"],
            .midRangeMade: ["{name}中投", "{number}號中距離", "{name}中投進了"],
    ...
    private static let englishTemplates = Templates(
        ...
        statTypeNames: [
            ("stat.foul", "foul"), ("stat.rebound", "rebound"), ("stat.assist", "assist"),
    ...
    private static let japaneseTemplates = Templates(
        ...
        statTypeNames: [
            ("stat.foul", "ファウル"), ("stat.rebound", "リバウンド"), ("stat.assist", "アシスト"),
    ...
    private static let koreanTemplates = Templates(
        ...
        statTypeNames: [
            ("stat.foul", "파울"), ("stat.rebound", "리바운드"), ("stat.assist", "어시스트"),
    ...
    private static let spanishTemplates = Templates(
        ...
        statTypeNames: [
            ("stat.foul", "falta"), ("stat.rebound", "rebote"), ("stat.assist", "asistencia"),
    ...
    private static let frenchTemplates = Templates(
        ...
        statTypeNames: [
            ("stat.foul", "faute"), ("stat.rebound", "rebond"), ("stat.assist", "passe decisive"),
    ...
    private static let italianTemplates = Templates(
        ...
        statTypeNames: [
            ("stat.foul", "fallo"), ("stat.rebound", "rimbalzo"), ("stat.assist", "assist"),
    ...
    private static let russianTemplates = Templates(
        ...
        statTypeNames: [
            ("stat.foul", "фол"), ("stat.rebound", "подбор"), ("stat.assist", "ассист"),
