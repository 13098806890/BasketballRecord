...
struct TutorialDataProvider {
    ...
    static func englishData(playerIDs: [UUID]) -> TutorialLocalizedData {
        ...
        let tasks = [
            ...
            taskDef(id: 32, desc: "John sinks a jump shot",
                    hint: "Say \"John shot\" · \"7 shot\" · \"John shot made\"",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 33, desc: "John misses a jump shot",
                    hint: "Say \"7 no shot\" · \"John shot miss\" · \"John missed shot\"",
                    playerID: ids[0], action: .twoMissed),
            taskDef(id: 34, desc: "Mike drives to the basket",
                    hint: "Say \"Mike drive\" · \"10 drive\" · \"Mike drive made\"",
                    playerID: ids[1], action: .twoMade),
            taskDef(id: 35, desc: "Mike misses on a drive",
                    hint: "Say \"10 no drive\" · \"Mike drive miss\"",
                    playerID: ids[1], action: .twoMissed),
            taskDef(id: 36, desc: "Steve scores on a fast break",
                    hint: "Say \"Steve fast break\" · \"7 fast break\" · \"Steve fast break made\"",
                    playerID: ids[2], action: .twoMade),
            taskDef(id: 37, desc: "Steve misses on a fast break",
                    hint: "Say \"7 no fast break\" · \"Steve fast break miss\"",
                    playerID: ids[2], action: .twoMissed),
            taskDef(id: 38, desc: "John with a jump shot",
                    hint: "Say \"John jump shot\" · \"John jump ball\" · \"7 jump shot made\"",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 39, desc: "John misses a jump shot",
                    hint: "Say \"7 no jump\" · \"John jump miss\"",
                    playerID: ids[0], action: .twoMissed),
        ]
    ...
    static func japaneseData(playerIDs: [UUID]) -> TutorialLocalizedData {
        ...
        let tasks = [
            ...
            taskDef(id: 31, desc: "ジー ドゥイ ダンク失敗",
                    ...
                    playerID: ids[2], action: .dunkMissed),
            taskDef(id: 32, desc: "田中がシュートを決める",
                    hint: "「田中シュート」·「7番シュート」·「田中シュート成功」",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 33, desc: "田中がシュートを外す",
                    hint: "「7番シュートなし」·「田中シュート失敗」",
                    playerID: ids[0], action: .twoMissed),
            taskDef(id: 34, desc: "鈴木がドライブから得点",
                    hint: "「鈴木ドライブ」·「10番ドライブ」·「鈴木ドライブ成功」",
                    playerID: ids[1], action: .twoMade),
            taskDef(id: 35, desc: "鈴木がドライブを外す",
                    hint: "「10番ドライブなし」·「鈴木ドライブ失敗」",
                    playerID: ids[1], action: .twoMissed),
            taskDef(id: 36, desc: "山田がファストブレイクで得点",
                    hint: "「山田ファストブレイク」·「7番ファストブレイク」·「山田ファストブレイク成功」",
                    playerID: ids[2], action: .twoMade),
            taskDef(id: 37, desc: "山田がファストブレイクを外す",
                    hint: "「7番ファストブレイクなし」·「山田ファストブレイク失敗」",
                    playerID: ids[2], action: .twoMissed),
            taskDef(id: 38, desc: "田中がジャンプショットを決める",
                    hint: "「田中ジャンプショット」·「田中ジャンプショット成功」",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 39, desc: "田中がジャンプショットを外す",
                    hint: "「7番ジャンプショットなし」·「田中ジャンプショット失敗」",
                    playerID: ids[0], action: .twoMissed),
        ]
        return TutorialLocalizedData(players: players, tasks: tasks, substitutionTaskID: 17, freePlayTaskID: 19)
    }
    ...
    static func koreanData(playerIDs: [UUID]) -> TutorialLocalizedData {
        ...
        let tasks = [
            ...
            taskDef(id: 31, desc: "쟈 두에이 덩크 실패",
                    ...
                    playerID: ids[2], action: .dunkMissed),
            taskDef(id: 32, desc: "김철수가 슛을 성공합니다",
                    hint: "「김철수 슛」·「7번 슛」·「김철수 슛 성공」",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 33, desc: "김철수가 슛을 놓칩니다",
                    hint: "「7번 슛 실패」·「김철수 슛 미스」",
                    playerID: ids[0], action: .twoMissed),
            taskDef(id: 34, desc: "이영희가 드라이브로 득점",
                    hint: "「이영희 드라이브」·「10번 드라이브」·「이영희 드라이브 성공」",
                    playerID: ids[1], action: .twoMade),
            taskDef(id: 35, desc: "이영희가 드라이브 실패",
                    hint: "「10번 드라이브 실패」·「이영희 드라이브 미스」",
                    playerID: ids[1], action: .twoMissed),
            taskDef(id: 36, desc: "박민수가 속공으로 득점",
                    hint: "「박민수 속공」·「7번 속공」·「박민수 속공 성공」",
                    playerID: ids[2], action: .twoMade),
            taskDef(id: 37, desc: "박민수가 속공 실패",
                    hint: "「7번 속공 실패」·「박민수 속공 미스」",
                    playerID: ids[2], action: .twoMissed),
            taskDef(id: 38, desc: "김철수가 점프슛을 성공",
                    hint: "「김철수 점프슛」·「김철수 점프슛 성공」",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 39, desc: "김철수가 점프슛 실패",
                    hint: "「7번 점프슛 실패」·「김철수 점프슛 미스」",
                    playerID: ids[0], action: .twoMissed),
        ]
        return TutorialLocalizedData(players: players, tasks: tasks, substitutionTaskID: 17, freePlayTaskID: 19)
    }
    ...
    static func germanData(playerIDs: [UUID]) -> TutorialLocalizedData {
        ...
        let tasks = [
            ...
            taskDef(id: 31, desc: "Zai Dui dunk miss",
                    hint: "Say \"Zai Dui dunk miss\" · \"Zai Dui dunk no\"",
                    playerID: ids[2], action: .dunkMissed),
            taskDef(id: 32, desc: "Hans trifft einen Sprungwurf",
                    hint: "„Hans Wurf\" · „7 Wurf\" · „Hans Wurf getroffen\"",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 33, desc: "Hans vergibt einen Sprungwurf",
                    hint: "„7 kein Wurf\" · „Hans Wurf daneben\"",
                    playerID: ids[0], action: .twoMissed),
            taskDef(id: 34, desc: "Fritz zieht zum Korb",
                    hint: "„Fritz Durchbruch\" · „10 Durchbruch\" · „Fritz Durchbruch Erfolg\"",
                    playerID: ids[1], action: .twoMade),
            taskDef(id: 35, desc: "Fritz scheitert beim Durchbruch",
                    hint: "„10 kein Durchbruch\" · „Fritz Durchbruch Fehlschlag\"",
                    playerID: ids[1], action: .twoMissed),
            taskDef(id: 36, desc: "Klaus punktet im Fastbreak",
                    hint: "„Klaus Fastbreak\" · „7 Fastbreak\" · „Klaus Fastbreak getroffen\"",
                    playerID: ids[2], action: .twoMade),
            taskDef(id: 37, desc: "Klaus vergibt im Fastbreak",
                    hint: "„7 kein Fastbreak\" · „Klaus Fastbreak daneben\"",
                    playerID: ids[2], action: .twoMissed),
            taskDef(id: 38, desc: "Hans mit einem Sprungwurf",
                    hint: "„Hans Sprungwurf\" · „Hans Sprungwurf getroffen\"",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 39, desc: "Hans Sprungwurf daneben",
                    hint: "„7 kein Sprungwurf\" · „Hans Sprungwurf Fehlschlag\"",
                    playerID: ids[0], action: .twoMissed),
        ]
        return TutorialLocalizedData(players: players, tasks: tasks, substitutionTaskID: 17, freePlayTaskID: 19)
    }
    ...
    static func spanishData(playerIDs: [UUID]) -> TutorialLocalizedData {
        ...
        let tasks = [
            ...
            taskDef(id: 31, desc: "Zai Dui dunk miss",
                    hint: "Say \"Zai Dui dunk miss\" · \"Zai Dui dunk no\"",
                    playerID: ids[2], action: .dunkMissed),
            taskDef(id: 32, desc: "Carlos anota un tiro saltando",
                    hint: "„Carlos tiro\" · „7 tiro\" · „Carlos tiro anotado\"",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 33, desc: "Carlos falla un tiro saltando",
                    hint: "„7 no tiro\" · „Carlos tiro fallo\"",
                    playerID: ids[0], action: .twoMissed),
            taskDef(id: 34, desc: "Luis penetra hacia la canasta",
                    hint: "„Luis penetración\" · „10 penetración\" · „Luis penetración anotado\"",
                    playerID: ids[1], action: .twoMade),
            taskDef(id: 35, desc: "Luis falla en la penetración",
                    hint: "„10 no penetración\" · „Luis penetración fallo\"",
                    playerID: ids[1], action: .twoMissed),
            taskDef(id: 36, desc: "José anota en un contraataque",
                    hint: "„José contraataque\" · „7 contraataque\" · „José contraataque anotado\"",
                    playerID: ids[2], action: .twoMade),
            taskDef(id: 37, desc: "José falla en un contraataque",
                    hint: "„7 no contraataque\" · „José contraataque fallo\"",
                    playerID: ids[2], action: .twoMissed),
            taskDef(id: 38, desc: "Carlos con un tiro saltando",
                    hint: "„Carlos tiro saltando\" · „Carlos tiro saltando anotado\"",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 39, desc: "Carlos falla un tiro saltando",
                    hint: "„7 no tiro saltando\" · „Carlos tiro saltando fallo\"",
                    playerID: ids[0], action: .twoMissed),
        ]
        return TutorialLocalizedData(players: players, tasks: tasks, substitutionTaskID: 17, freePlayTaskID: 19)
    }
    ...
    static func frenchData(playerIDs: [UUID]) -> TutorialLocalizedData {
        ...
        let tasks = [
            ...
            taskDef(id: 31, desc: "Zai Dui dunk miss",
                    hint: "Say \"Zai Dui dunk miss\" · \"Zai Dui dunk no\"",
                    playerID: ids[2], action: .dunkMissed),
            taskDef(id: 32, desc: "Pierre marque un tir en suspension",
                    hint: "„Pierre tir\" · „7 tir\" · „Pierre tir réussi\"",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 33, desc: "Pierre rate un tir en suspension",
                    hint: "„7 pas de tir\" · „Pierre tir raté\"",
                    playerID: ids[0], action: .twoMissed),
            taskDef(id: 34, desc: "Paul perce vers le panier",
                    hint: "„Paul percée\" · „10 percée\" · „Paul percée réussie\"",
                    playerID: ids[1], action: .twoMade),
            taskDef(id: 35, desc: "Paul rate sa percée",
                    hint: "„10 pas de percée\" · „Paul percée ratée\"",
                    playerID: ids[1], action: .twoMissed),
            taskDef(id: 36, desc: "Jacques marque en contre-attaque",
                    hint: "„Jacques contre attaque\" · „7 contre attaque\" · „Jacques contre attaque réussi\"",
                    playerID: ids[2], action: .twoMade),
            taskDef(id: 37, desc: "Jacques rate en contre-attaque",
                    hint: "„7 pas de contre attaque\" · „Jacques contre attaque raté\"",
                    playerID: ids[2], action: .twoMissed),
            taskDef(id: 38, desc: "Pierre avec un tir en suspension",
                    hint: "„Pierre tir en suspension\" · „Pierre tir en suspension réussi\"",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 39, desc: "Pierre rate un tir en suspension",
                    hint: "„7 pas de tir en suspension\" · „Pierre tir en suspension raté\"",
                    playerID: ids[0], action: .twoMissed),
        ]
        return TutorialLocalizedData(players: players, tasks: tasks, substitutionTaskID: 17, freePlayTaskID: 19)
    }
    ...
    static func italianData(playerIDs: [UUID]) -> TutorialLocalizedData {
        ...
        let tasks = [
            ...
            taskDef(id: 31, desc: "Zai Dui dunk miss",
                    hint: "Say \"Zai Dui dunk miss\" · \"Zai Dui dunk no\"",
                    playerID: ids[2], action: .dunkMissed),
            taskDef(id: 32, desc: "Marco segna un tiro in sospensione",
                    hint: "„Marco tiro\" · „7 tiro\" · „Marco tiro segnato\"",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 33, desc: "Marco sbaglia un tiro in sospensione",
                    hint: "„7 no tiro\" · „Marco tiro sbagliato\"",
                    playerID: ids[0], action: .twoMissed),
            taskDef(id: 34, desc: "Luca penetra verso il canestro",
                    hint: "„Luca penetrazione\" · „10 penetrazione\" · „Luca penetrazione segnata\"",
                    playerID: ids[1], action: .twoMade),
            taskDef(id: 35, desc: "Luca sbaglia in penetrazione",
                    hint: "„10 no penetrazione\" · „Luca penetrazione sbagliata\"",
                    playerID: ids[1], action: .twoMissed),
            taskDef(id: 36, desc: "Paolo segna in contropiede",
                    hint: "„Paolo contropiede\" · „7 contropiede\" · „Paolo contropiede segnato\"",
                    playerID: ids[2], action: .twoMade),
            taskDef(id: 37, desc: "Paolo sbaglia in contropiede",
                    hint: "„7 no contropiede\" · „Paolo contropiede sbagliato\"",
                    playerID: ids[2], action: .twoMissed),
            taskDef(id: 38, desc: "Marco con un tiro in sospensione",
                    hint: "„Marco tiro in sospensione\" · „Marco tiro in sospensione segnato\"",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 39, desc: "Marco sbaglia un tiro in sospensione",
                    hint: "„7 no tiro in sospensione\" · „Marco tiro in sospensione sbagliato\"",
                    playerID: ids[0], action: .twoMissed),
        ]
        return TutorialLocalizedData(players: players, tasks: tasks, substitutionTaskID: 17, freePlayTaskID: 19)
    }
    ...
    static func russianData(playerIDs: [UUID]) -> TutorialLocalizedData {
        ...
        let tasks = [
            ...
            taskDef(id: 31, desc: "Цзай Дуй данк промах",
                    ...
                    playerID: ids[2], action: .dunkMissed),
            taskDef(id: 32, desc: "Иван забивает бросок в прыжке",
                    hint: "«Иван бросок»·«7 бросок»·«Иван бросок попал»",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 33, desc: "Иван промахивается броском в прыжке",
                    hint: "«7 нет броска»·«Иван бросок промах»",
                    playerID: ids[0], action: .twoMissed),
            taskDef(id: 34, desc: "Пётр проходит к кольцу",
                    hint: "«Пётр проход»·«10 проход»·«Пётр проход попал»",
                    playerID: ids[1], action: .twoMade),
            taskDef(id: 35, desc: "Пётр промахивается в проходе",
                    hint: "«10 нет прохода»·«Пётр проход промах»",
                    playerID: ids[1], action: .twoMissed),
            taskDef(id: 36, desc: "Сергей забивает в быстром прорыве",
                    hint: "«Сергей быстрый прорыв»·«7 быстрый прорыв»·«Сергей быстрый прорыв попал»",
                    playerID: ids[2], action: .twoMade),
            taskDef(id: 37, desc: "Сергей промахивается в быстром прорыве",
                    hint: "«7 нет быстрого прорыва»·«Сергей быстрый прорыв промах»",
                    playerID: ids[2], action: .twoMissed),
            taskDef(id: 38, desc: "Иван с броском в прыжке",
                    hint: "«Иван прыжок»·«Иван прыжок попал»",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 39, desc: "Иван промахивается броском в прыжке",
                    hint: "«7 нет прыжка»·«Иван прыжок промах»",
                    playerID: ids[0], action: .twoMissed),
        ]
        return TutorialLocalizedData(players: players, tasks: tasks, substitutionTaskID: 17, freePlayTaskID: 19)
    }
    ...
    static func chineseData(playerIDs: [UUID]) -> TutorialLocalizedData {
        ...
        let tasks = [
            ...
            taskDef(id: 31, desc: "仔隊扣籃不中",
                    ...
                    playerID: ids[2], action: .dunkMissed),
            taskDef(id: 32, desc: "老张投篮命中",
                    hint: "请说「老张投篮」·「老张投篮命中」",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 33, desc: "老张投篮不中",
                    hint: "请说「老张投篮不中」·「老张投篮没进」",
                    playerID: ids[0], action: .twoMissed),
            taskDef(id: 34, desc: "俊宏突破命中",
                    hint: "请说「俊宏突破」·「10号突破」·「俊宏突破命中」",
                    playerID: ids[1], action: .twoMade),
            taskDef(id: 35, desc: "俊宏突破不中",
                    hint: "请说「俊宏突破不中」·「10号突破没进」",
                    playerID: ids[1], action: .twoMissed),
            taskDef(id: 36, desc: "仔队跳投命中",
                    hint: "请说「仔队跳投」·「客队7号跳投」·「仔队跳投命中」",
                    playerID: ids[2], action: .twoMade),
            taskDef(id: 37, desc: "仔队跳投不中",
                    hint: "请说「仔队跳投不中」·「客队7号跳投没进」",
                    playerID: ids[2], action: .twoMissed),
            taskDef(id: 38, desc: "老张快攻得分",
                    hint: "请说「老张快攻」·「7号快攻」·「老张快攻命中」",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 39, desc: "老张快攻不中",
                    hint: "请说「老张快攻不中」·「7号快攻没进」",
                    playerID: ids[0], action: .twoMissed),
        ]
        return TutorialLocalizedData(players: players, tasks: tasks, substitutionTaskID: 17, freePlayTaskID: 19)
    }
    ...
    static func traditionalChineseData(playerIDs: [UUID]) -> TutorialLocalizedData {
        ...
        let tasks = [
            ...
            taskDef(id: 31, desc: "仔隊扣籃不中",
                    hint: "請說「仔隊扣籃沒進」·「仔隊扣進不中」",
                    playerID: ids[2], action: .dunkMissed),
            taskDef(id: 32, desc: "老張投籃命中",
                    hint: "請說「老張投籃」·「老張投籃命中」",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 33, desc: "老張投籃不中",
                    hint: "請說「老張投籃不中」·「老張投籃沒進」",
                    playerID: ids[0], action: .twoMissed),
            taskDef(id: 34, desc: "俊宏突破命中",
                    hint: "請說「俊宏突破」·「10號突破」·「俊宏突破命中」",
                    playerID: ids[1], action: .twoMade),
            taskDef(id: 35, desc: "俊宏突破不中",
                    hint: "請說「俊宏突破不中」·「10號突破沒進」",
                    playerID: ids[1], action: .twoMissed),
            taskDef(id: 36, desc: "仔隊跳投命中",
                    hint: "請說「仔隊跳投」·「客隊7號跳投」·「仔隊跳投命中」",
                    playerID: ids[2], action: .twoMade),
            taskDef(id: 37, desc: "仔隊跳投不中",
                    hint: "請說「仔隊跳投不中」·「客隊7號跳投沒進」",
                    playerID: ids[2], action: .twoMissed),
            taskDef(id: 38, desc: "老張快攻得分",
                    hint: "請說「老張快攻」·「7號快攻」·「老張快攻命中」",
                    playerID: ids[0], action: .twoMade),
            taskDef(id: 39, desc: "老張快攻不中",
                    hint: "請說「老張快攻不中」·「7號快攻沒進」",
                    playerID: ids[0], action: .twoMissed),
        ]
        return TutorialLocalizedData(players: players, tasks: tasks, substitutionTaskID: 17, freePlayTaskID: 19)
    }
